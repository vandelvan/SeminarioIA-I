...
public class Handson6GUI extends JFrame {
	private Handson6Agent myAgent;

	private JTextField xValueInput;

	public Handson6GUI(Handson6Agent a) {
            ...
            addButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent ev) {
                            try {
                                    ...
                                    JOptionPane.showMessageDialog(Handson6GUI.this, "Invalid values. "+e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                            }
                    }
            } );
            p = new JPanel();
